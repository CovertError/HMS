        ...
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfl tp-resizeme" 
                ...
                data-endspeed="300"
                style="z-index: 5; font-size:50px; font-weight:500; color:#fff;  max-width: auto; max-height: auto; white-space: nowrap;">Care And Cure</div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-4">
                      <div class="doctor-img"> <img class="img-responsive" src="images/depart-doctor-img-1.jpg" alt="" >
                        <div class="name-doc">
                          <h6>Prof. Dr. Asia Khanam <span>Cardiology Specialists</span></h6>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-4">
                      <div class="doctor-img"> <img class="img-responsive" src="images/depart-doctor-img-2.jpg" alt="" >
                        <div class="name-doc">
                          <h6>Asso. Prof. Dr. Indrajit Prashad<span>Cardiology Specialists</span></h6>
                        </div>
                      </div>
                    </div>
                  </div>
